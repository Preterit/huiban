...
public class YRecycleview extends RecyclerView {
     ...
     * 是否可以刷新的常量
     */
    public boolean pullRefreshEnabled = true;
    /**
     * 是否可以加载更多的常量
     */
...
//        Debugging.debugging("(state == RecyclerView.SCROLL_STATE_IDLE) = " + (state == RecyclerView.SCROLL_STATE_IDLE));
//        Debugging.debugging("(refreshAndLoadMoreListener != null) = " + (refreshAndLoadMoreListener != null));
//        Debugging.debugging("(isLoadingData) = " + (isLoadingData));
//        Debugging.debugging("(loadMoreEnabled) = " + (loadMoreEnabled));
