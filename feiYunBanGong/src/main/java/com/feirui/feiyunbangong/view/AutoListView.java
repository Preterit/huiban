...
public class AutoListView extends ListView implements OnScrollListener {
	...
	private ProgressBar refreshing;// 头部进度�?

	private TextView noData; // 无数�?
	private TextView loadFull; // 加载完毕
	private TextView more; // 还可以继续加�?
	private ProgressBar loading;// 底部进度�?
	...
	private void initView(Context context) {
		...
		tip = (TextView) header.findViewById(R.id.tip);// 松开或下�?
		lastUpdate = (TextView) header.findViewById(R.id.lastUpdate);// 时间
		refreshing = (ProgressBar) header.findViewById(R.id.refreshing);// 进度�?
	...
	public void onRefreshComplete(String updateTime) {
		lastUpdate.setText(this.getContext().getString(
