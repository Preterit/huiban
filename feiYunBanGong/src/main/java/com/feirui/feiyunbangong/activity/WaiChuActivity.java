...
public class WaiChuActivity extends BaseActivity implements OnClickListener {
    ...
    // 添加审批人
    @PView(click = "onClick")
    ImageView iv_add, iv_01, iv_tupian1, iv_tupian2, iv_tupian3,iv_add_chaosong;
...
//			startActivityForResult(intent, 101);// 请求码；
    ...
    public void commit(){
        ...
        params.put("out_start", tv_kaishishijian.getText().toString().trim());
        params.put("out_end", tv_jieshushijian.getText().toString().trim());
        params.put("out_time", et_time.getText().toString().trim());
        params.put("reason", et_shiyou.getText().toString().trim());
        ...
        String url = UrlTools.url1 + UrlTools.OUT_APP_OUT;
        Log.e("审批-外出", url +"---"+ params);
        AsyncHttpServiceHelper.post(url, params,
                new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int arg0, Header[] arg1,
                        ...
                        final JsonBean json = JsonUtils.getMessage(new String(arg2));
...
//								T.showShort(WaiChuActivity.this, json.getMsg());
                            T.showShort(WaiChuActivity.this, "外出-提交失败");
                        }
                    }
