 ...
 *
 */
public class DataStatement2Activity extends BaseActivity {
	@PView(click = "onClick")
	...
	private void initDate(String date) {
		...
		L.e("数据报表-周报url" + url + " params" + params);
		AsyncHttpServiceHelper.post(url, params,
				new AsyncHttpResponseHandler() {
					...
					public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
						...
						L.e("数据报表-周报****************" + new String(arg2));
						if ("200".equals(json.getCode())) {
							runOnUiThread(new Runnable() {
								public void run() {
									BitmapUtils bitmapUtils = new BitmapUtils(
											DataStatement2Activity.this);
									adapter = new DataStatementAdapter(
											DataStatement2Activity.this, json,
											bitmapUtils);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
			long id) {
		Intent intent = new Intent(DataStatement2Activity.this,
