 ...
 * @author admina
 */
public class DataStatement1Activity extends BaseActivity {
    @PView(click = "onClick")
    ...
    private void initDate(String date) {
        ...
        L.e("数据报表-日报url" + url + " params" + params);
        AsyncHttpServiceHelper.post(url, params,
                new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
                        ...
                        L.e("数据报表-日报****************" + new String(arg2));
                        if ("200".equals(json.getCode())) {
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    BitmapUtils bitmapUtils = new BitmapUtils(
                                            DataStatement1Activity.this);
                                    adapter = new DataStatementAdapter(
                                            DataStatement1Activity.this, json,
                                            bitmapUtils);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
                            long id) {
        Intent intent = new Intent(DataStatement1Activity.this,
