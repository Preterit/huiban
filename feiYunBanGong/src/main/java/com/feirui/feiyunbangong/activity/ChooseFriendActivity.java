...
public class ChooseFriendActivity extends BaseActivity implements
        View.OnClickListener, AllInterface.OnGroupStateChangedListener{
...
//		setRightVisibility(false);
        leftIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("childs", new ArrayList<ChildItem>());
        ...
        Utils.doPost(LoadingDialog.getInstance(this), this, url01, null,
                new Utils.HttpCallBack() {
                    ...
                    public void failure(String msg) {
                        T.showShort(ChooseFriendActivity.this, msg);
                    }
...
//				startActivity(mIMKit.getChattingActivityIntent(ywMessage.getContent()));
    ...
    private void sendMeg() {
        ...
        T.showShort(ChooseFriendActivity.this, "转发成功");
        finish();
    }
