 ...
 *
 */
public class Statement3Activity extends BaseActivity implements OnClickListener {
	@PView(click = "onClick")
	Button btn_submit;// 提交
	@PView
	TextView tv_1, tv_2, tv_3;// 完成，总结，计划
	@PView
	EditText et_1, et_2, et_3, et_beizhu;// 完成，总结，计划，备注
