...
//		findViewById(R.id.lay_login).setOnClickListener(new View.OnClickListener() {
//			@Override
...
//		});
    ...
    private void showWindow(View v) {
        ...
        if (set != null) {
            ...
            popupWindow.showAsDropDown(et_login_password,0,-10);
            // 使其聚集
            ...
            popupWindow.showAsDropDown(et_login_username, Gravity.CENTER_HORIZONTAL, 0);
