 ...
 *
 */
public class DataStatement4Activity extends BaseActivity {
	@PView(click = "onClick")
	...
	private void initDate(String date) {
		...
		L.e("数据报表-业绩报表url" + url + " params" + params);
		AsyncHttpServiceHelper.post(url, params,
				new AsyncHttpResponseHandler() {
					...
					public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
						...
						L.e("数据报表-业绩报表****************" + new String(arg2));
						if ("200".equals(json.getCode())) {
							runOnUiThread(new Runnable() {
								public void run() {
									BitmapUtils bitmapUtils = new BitmapUtils(
											DataStatement4Activity.this);
									adapter = new DataStatementAdapter(
											DataStatement4Activity.this, json,
											bitmapUtils);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
			long id) {
		Intent intent = new Intent(DataStatement4Activity.this,
