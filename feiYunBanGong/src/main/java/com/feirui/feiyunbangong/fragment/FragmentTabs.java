...
//
///**
// * Created by feirui1 on 2017-07-21.
// */
//
...
//        mTabHost.addTab(mTabHost.newTabSpec(TAB_TRIBE).setIndicator(indicator), TribeActivity.class, fragmentBundle);
//
//
...
//        View tabView = View.inflate(this, R.layout.tab_item, null);
